...
import com.poidevin.beans.org.openstreetmap.gui.jmapviewer.interfaces.TileJob;
...
public class OsmTileLoader implements TileLoader {
    ...
    protected URLConnection loadTileFromOsm(Tile tile) throws IOException {
        ...
        //TODO keep in case of local OSM server down
//        Proxy proxy = new Proxy(Proxy.Type.HTTP, new InetSocketAddress("192.168.3.2",8080));
